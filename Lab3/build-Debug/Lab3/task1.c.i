# 0 "C:/Development/Codelite/Lab3/Lab3/Lab3/task1.c"
# 1 "C:\\Development\\Codelite\\Lab3\\Lab3\\Lab3//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "C:/Development/Codelite/Lab3/Lab3/Lab3/task1.c"
...
# 2 "C:/Development/Codelite/Lab3/Lab3/Lab3/task1.c" 2
# 1 "C:/msys64/ucrt64/lib/gcc/x86_64-w64-mingw32/15.1.0/include/stdbool.h" 1 3 4
# 3 "C:/Development/Codelite/Lab3/Lab3/Lab3/task1.c" 2
...
# 9 "C:/Development/Codelite/Lab3/Lab3/Lab3/task1.c"
...
void reshape(int arr[], int length, int arr2d[8][3], int rows, int cols);
void printTransMatrix(int arr2d[8][3], int rows, int cols);
...
int main() {
    ...
    insert_align(arr, 24, 3, 99);
    printArray(arr, 24);


    printf("\nReshaping array into 2D matrix (row by row):\n");
    reshape(arr, 24, arr2d, 8, 3);
    printMatrix(arr2d, 8);


    printf("\nPrinting the transposed matrix (column by column):\n");
    printTransMatrix(arr2d, 8, 3);


    if (foundDuplicate(arr, 24))
    ...
    printf("\nFlipped array:\n");
    flipArray(arr, 24, flipped);
    printArray(flipped, 24);
